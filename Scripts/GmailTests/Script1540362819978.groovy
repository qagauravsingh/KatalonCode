...
WebUI.setText(findTestObject('Object Repository/Page_Gmail/input_Continue to Gmail_identi'), 'qa.gauravsingh01@gmail.com')

WebUI.click(findTestObject('Page_Gmail/Next_Button'))

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Gmail/input_Too many failed attempts'), 'eHhmHd1OW+ZNBtbkPgWCsA==')
